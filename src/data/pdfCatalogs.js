...
export const pdfCatalogs = [
  {
    ...
    logoSrc: getImageUrl('public/img/Marcas/terramar.png'),
    logoAlt: 'Logo Terramar Brands',
    bgGradient: 'linear-gradient(135deg, #0a4f7a 0%, #0e7db5 100%)',
    productName: 'Terramar Suero Vitamina C',
    productImageSrc: getImageUrl('public/img/productos_std/Terramar Suero Vitamina C.jpg'),
  ...
  },
  {
    ...
    logoSrc: getImageUrl('public/img/Marcas/forever.png'),
    logoAlt: 'Logo Forever Living',
    bgGradient: 'linear-gradient(135deg, #F7BF01 0%, #F8D45E 100%)',
    productName: 'Forever Aloe Vera Gel',
    productImageSrc: getImageUrl('public/img/productos_std/Forever Aloe Vera Gel.webp'),
